...
const EditFlightBaggageStatusPageGHM = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    resetData()
    navigate('/ghm/view-flight-baggage-status')
  }
          ...
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <div className="d-flex mt-4 gap-2">
              ...
              <button
                ...
                type="button"
                onClick={() => navigate('/ghm/view-flight-baggage-status')}
              >
                Back
              </button>
            </div>
...
export default EditFlightBaggageStatusPageGHM
