...
import { createRefuelingSchedule } from '@renderer/controllers/RefuelingScheduleController'

const CreateRefuelingSchedulePage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await createRefuelingSchedule(newRefuelingSchedule)
    resetData()
...
export default CreateRefuelingSchedulePage
