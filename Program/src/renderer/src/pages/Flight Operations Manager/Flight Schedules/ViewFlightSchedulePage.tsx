                ...
                {flightSchedulesData.map((flightSchedule, index) => (
                  <tr key={flightSchedule.id}>
                    ...
                    <td className="text-center">
                      <Link to={`/fom/edit-flight-schedule/${flightSchedule.id}`}>
                        <i className="bi bi-pencil-fill text-primary"></i>
                      </Link>
                    </td>
                    <td className="text-center">
                      <Link to={`/fom/delete-flight-schedule/${flightSchedule.id}`}>
...
export default ViewFlightSchedulePage
