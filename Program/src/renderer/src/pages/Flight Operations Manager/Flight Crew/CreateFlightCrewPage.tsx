...
import { checkCrewNameUnique, createFlightCrew } from '@renderer/controllers/FlightCrewController'
...
const CreateFlightCrewPage = () => {
  ...
  const validateCrewName = async () => {
    ...
    else if (!(await checkCrewNameUnique(crewName))) setErrorCrewName('Crew name already exists!')
  }
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await createFlightCrew(newFlightCrew)
    resetData()
