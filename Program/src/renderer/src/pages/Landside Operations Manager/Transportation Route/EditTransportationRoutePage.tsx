...
const EditTransportationRoutePage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await updateTransportationRoute(newTransporationRoute, id)
    resetData()
...
export default EditTransportationRoutePage
