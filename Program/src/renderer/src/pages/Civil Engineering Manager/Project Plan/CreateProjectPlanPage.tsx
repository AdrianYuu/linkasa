...
import { createProjectPlan } from '@renderer/controllers/ProjectPlanController'

const CreateProjectPlanPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await createProjectPlan(newProjectPlan)
    resetData()
...
export default CreateProjectPlanPage
