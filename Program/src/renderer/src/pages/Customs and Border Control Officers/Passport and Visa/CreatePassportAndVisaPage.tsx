...
import { createPassportAndVisa } from '@renderer/controllers/PassportAndVisaController'

const CreatePassportAndVisaPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await createPassportAndVisa(newPassportAndVisa)
    resetData()
...
export default CreatePassportAndVisaPage
