...
const EditInspectionRecordPage = () => {
  ...
  const fillData = () => {
    ...
    setOldURL(inspectionRecordData.photographURL)
  }
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await updateInspectionRecord(newInspectionRecord, id)
    resetData()
...
export default EditInspectionRecordPage
