...
import { getAirportGoal, updateAirportGoal } from '@renderer/controllers/AirportGoalController'

const EditAirportGoalPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await updateAirportGoal(newAirportGoal, id)
    resetData()
...
export default EditAirportGoalPage
