...
const EditFlightSchedulePageAOM = () => {
  ...
  const [errorBaggageStatusAOM, setErrorBaggageStatusAOM] = useState('')

  useEffect(() => {
    setErrorBaggageStatusAOM('')
    if (baggageStatusAOM === '') setErrorBaggageStatusAOM("Baggage Status can't be empty!")
  }, [baggageStatusAOM])
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const isValid = !errorBaggageStatusAOM
    ...
    resetData()
    navigate('/aom/view-flight-schedule')
  }
        ...
        <div className="px-5 py-4 overflow-hidden">
          ...
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="text-danger">{errorBaggageStatusAOM}</p>
            </div>
            <div>
            ...
            <div className="d-flex mt-4 gap-2">
              ...
              <button
                ...
                type="button"
                onClick={() => navigate('/aom/view-flight-schedule')}
              >
                Back
              </button>
            </div>
...
export default EditFlightSchedulePageAOM
