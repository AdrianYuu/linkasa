...
import { checkPersonalEmailUnique } from '@renderer/controllers/AuthController'
import { getEmployee, updateEmployee } from '@renderer/controllers/EmployeeController'
...
const EditEmployeePage = () => {
  ...
  const fillData = () => {
    ...
    setOldEmail(employeeData.personalEmail)
  ...
  const validatePersonalEmail = async () => {
    ...
    else if (!(await checkPersonalEmailUnique(personalEmail)) && personalEmail !== oldEmail)
