...
import {
  ...
  updateEmployeeDevelopmentProgram
} from '@renderer/controllers/EmployeeDevelopmentProgramController'

const EditEmployeeDevelopmentProgramPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await updateEmployeeDevelopmentProgram(newEmployeeDevelopmentProgram, id)
    resetData()
      ...
      <div className="w-100 overflow-auto">
        ...
        <div className="px-5 py-4 overflow-hidden">
          <h5 className="mt-2 mb-4 text-muted">
            ...
            Edit Employee Development Program
          </h5>
...
export default EditEmployeeDevelopmentProgramPage
