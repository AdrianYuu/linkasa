...
import { createMaintenanceSchedule } from '@renderer/controllers/MaintenanceScheduleController'

const CreateMaintenanceSchedulePage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await createMaintenanceSchedule(newMaintenanceSchedule)
    resetData()
