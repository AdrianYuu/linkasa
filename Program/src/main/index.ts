...
import icon from '../../resources/LinKasaIcon.jpg?asset'
...
function createWindow(): void {
  ...
  const contextMenu = Menu.buildFromTemplate([
    ...
    {
      label: 'Restore Application Size',
      click: () => {
        mainWindow.restore()
      }
    },
    {
      label: 'Maximize Application',
      click: () => {
        mainWindow.maximize()
      }
    }
  ...
  appLogo.setContextMenu(contextMenu)
}
